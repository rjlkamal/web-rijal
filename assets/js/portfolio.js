...
const DOCUMENTS = [
  {
    ...
    desc: 'Riwayat singkat pendidikan, pengalaman, dan kemampuan.',
    category: 'cv',
  },
  {
    file: 'SERTIFIKAT BERPRESTASI .pdf',
    title: 'Sertifikat Pretasi',
    desc: 'Sertifikat siswa berprestasi di sekolah dalam bilang kerohanian',
    category: 'sertifikat',
  },
  {
    file: 'Sertifikat FLP 2 _660.pdf',
    title: 'Sertifikat Pelatihan',
    desc: 'Sertifikat keikutsertaan dalam kegiatan pelatihan tanggap darurat K3 kebakaran pada industri migas.',
    category: 'sertifikat',
  },
  {
    file: 'penghargaan olimpiade rijal.pdf',
    title: 'Sertifikat Penghargaan',
    desc: 'Sertifikat  penghargaan peraih medali emas dalam olimpiade PAI SMA.',
    category: 'sertifikat',
  },
  {
    file: 'sertifikat ketua rohis (1).pdf',
    title: 'Sertifkat Ketua Rohis',
    desc: 'Sertifikat penghargaan sebagai ketua rohis SMAN 5 Cilegon.',
    category: 'sertifikat',
  },
  {
    file: 'Sertifikat lkmm td.pdf',
    title: 'Sertifikat LKMMTD',
    desc: 'Sertifikat keikutsertaan dalam latihan keterampilan manajemen mahasiswa tingkat dasar.',
    category: 'sertifikat',
  },
  {
    file: 'sertifikat smanli expo .pdf',
    title: 'Sertifikat Smanli Expo',
    desc: 'Sertifikat keikutsertaan sebagai panitia koordinator korlap dalam acara SMANLI EXPO 2026.',
    category: 'sertifikat',
  },
  {
    file: 'sertifikat_rijal_2.jpg.jpeg',
    title: 'Sertifikat LKMMPD',
    desc: 'Sertifikat keikutsertaan dalam latihan keterampilan manajemen mahasiswa pra-dasar.',
    category: 'sertifikat',
  },
];
